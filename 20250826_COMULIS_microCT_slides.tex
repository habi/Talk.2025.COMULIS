...
\begin{frame}[allowframebreaks]
	...
	\mode<beamer>{\animategraphics[autoplay,loop,height=\imageheight,every=\everyframe]{9}{./movies/scan/acquisition/TOMO_gif_CT_signed00}{00}{91}\sourceqr{https://sites.google.com/a/fulbrightmail.org/kesnersmedicalphysics/home/education/3d-image-reconstruction-explained-with-animated-gifs}}%
...
\begin{frame}[allowframebreaks]
	...
	\centering%
	% Movie downloaded from https://sites.google.com/a/fulbrightmail.org/kesnersmedicalphysics/home/education/3d-image-reconstruction-explained-with-animated-gifs, sligthly cropped in ImageJ, saved out and PNG images and piped through oxipng
	\mode<beamer>{\animategraphics[autoplay,loop,height=\imageheight,every=\everyframe]{5}{./movies/scan/sinogram/TOMO_FBP_gif_CT_signed00}{00}{61}\sourceqr{https://sites.google.com/a/fulbrightmail.org/kesnersmedicalphysics/home/education/3d-image-reconstruction-explained-with-animated-gifs}}%
...
\begin{frame}
	...
	\begin{itemize}
		\item \textquote[\cite{xrayphysics}]{X-rays interact with tissue in 2 main ways: photoelectric effect and Compton scatter.
				\textelp{T}he photoelectric effect contributes to contrast while the Compton effect contributes to noise.}
		\begin{itemize}
			...
			\note{From \href{https://radiopaedia.org/articles/photoelectric-effect}{Radiopaedia.org}: Therefore if \(Z\) doubles, PEA will increase by a factor of 16 (\(2^4=16\)), and if \(E\) doubles PEA will be reduced by a factor of 11.
		 	...
		 	\item Compton scattering is one of the principle forms of photon interaction and is directly proportional to the (electron \& physical) density of the material, and does \emph{not} depend on \(Z\).
...
\mode<beamer>{%
	\begin{frame}
		...
		\end{tikzpicture}%
		Collaboration with \href{https://www.zmk.unibe.ch/}{zmk bern – Zahnmedizinische Kliniken}\cite{Haberthuer2021}
		\begin{itemize}
...
\begin{frame}
	...
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center) [shift={(0,-25pt)}]{%
			...
			\only<2|handout:2>{\includegraphics[width=.8\textwidth]{./images/briseno}\sourcecite{Briseno-Marroquin2015}{Fig.~2}}%
			\only<3|handout:3>{%
				\mode<beamer>{%
...
\begin{frame}
	\frametitle{Data wrangling by example: Cichlids}
	\centering%
	\includegraphics<1|handout:0>[height=\imageheight]{./images/cichlids/Otolither_104016_head_01_Overview}%
	\includegraphics<2|handout:0>[height=\imageheight]{./images/cichlids/Otolither_104016_head_02_GrayValues}%
	\includegraphics<3|handout:0>[height=\imageheight]{./images/cichlids/Otolither_104016_head_03_GrayValuesRegion}%
	\includegraphics<4|handout:1>[height=\imageheight]{./images/cichlids/Otolither_104016_head_04_GrayValuesSmoothed}%
	\includegraphics<5|handout:0>[height=\imageheight]{./images/cichlids/Otolither_104016_head_05_Peaks}%
	\includegraphics<6|handout:0>[height=\imageheight]{./images/cichlids/Otolither_104016_head_06_Peaks_All}%
	\includegraphics<7|handout:0>[height=\imageheight]{./images/cichlids/Otolither_104016_head_07_ExtractedRegions}%
	\includegraphics<8|handout:0>[height=\imageheight]{./images/cichlids/Otolither_104016_head_08_ExtractedRegionsMIPs}%
	\includegraphics<9|handout:2>[height=\imageheight]{./images/cichlids/Otolither_104016_head_09_ExtractedOtolithMasked}%
