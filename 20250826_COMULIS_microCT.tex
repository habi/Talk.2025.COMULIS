		...
		\begin{column}{0.6177\linewidth}
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item Vasculature: (mouse) brain~\cite{Hlushchuk2020}, (human) nerve scaffolds~\cite{Wuthrich2020}, (human) skin flaps~\cite{Zubler2021}, tumors\cite{Fernandez2025} and bones\cite{Haberthuer2025}
				\end{itemize}
...
% 	\centering
	...
	\mode<beamer>{\animategraphics[autoplay,loop,height=\imageheight,every=\everyframe]{24}{./movies/scan/acquisition/TOMO_gif_CT_signed00}{00}{91}\sourceqr{https://sites.google.com/a/fulbrightmail.org/kesnersmedicalphysics/home/education/3d-image-reconstruction-explained-with-animated-gifs}}%
	\mode<handout>{\includegraphics[height=\imageheight]{./movies/scan/acquisition/acquisition/TOMO_gif_CT_signed0020}\sourceqr{https://sites.google.com/a/fulbrightmail.org/kesnersmedicalphysics/home/education/3d-image-reconstruction-explained-with-animated-gifs}}%
% \end{frame}
...
\begin{frame}[allowframebreaks]
	...
	\centering
	% Movie downloaded from https://sites.google.com/a/fulbrightmail.org/kesnersmedicalphysics/home/education/3d-image-reconstruction-explained-with-animated-gifs, sligthly cropped in ImageJ, saved out and PNG images and piped through oxipng
	\mode<beamer>{\animategraphics[autoplay,loop,height=\imageheight,every=\everyframe]{24}{./movies/scan/sinogram/TOMO_FBP_gif_CT_signed00}{00}{61}\sourceqr{https://sites.google.com/a/fulbrightmail.org/kesnersmedicalphysics/home/education/3d-image-reconstruction-explained-with-animated-gifs}}%
	\mode<handout>{\includegraphics[height=\imageheight]{./movies/scan/sinogram/acquisition/TOMO_FBP_gif_CT_signed0055}\sourceqr{https://sites.google.com/a/fulbrightmail.org/kesnersmedicalphysics/home/education/3d-image-reconstruction-explained-with-animated-gifs}}%
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.3822\linewidth}
			\begin{itemize}
				\item Collaboration, part of a \emph{much} bigger story\footcite{Garcia-Poyatos2024}
